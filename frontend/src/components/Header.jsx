...
/**
 * Header component displays the app header with logo and title
 * @returns {JSX.Element} A styled header component
 */
const Header = () => (
    ...
    <div className="max-w-4xl mx-auto px-4 py-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">Your personal fashion curator</p>
        </div>
      </div>
    </div>
  </div>
